...
# How they were made.
These JARs were compiled using the exact instructions provided by the Meteor developers on their website that you can find [here.](https://meteorclient.com/faq/old-versions)
...
[The Meteor Development Team](https://github.com/MeteorDevelopment) for [Meteor Client.](https://github.com/MeteorDevelopment)

# Licensing
This project redistributes software under the GNU General Public License v3.0.

All credit goes to the Meteor Development Team.

You can find the original source code at both this repository and the official Meteor Github repository.

As per GPLv3, the matching source code for every build available is provided.

Disclaimer: This is an unofficial community-led archive. **Use at your own risk. This project is not affiliated with by Meteor Development.**

If you reupload a modified version of Meteor Client, you **MUST** upload your source code of your final product to where you are sharing your file.

You must use the **same license this repository is licensed under.** (GNU General Public License v3.0.)

And you must say **clearly and obviously** that there is code being used from Meteor Development's Meteor Client.
